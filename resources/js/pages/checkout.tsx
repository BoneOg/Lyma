...
export default function Checkout() {
  ...
  const handleExpired = () => {
    // Redirect to reservation page with expired param for notification
        ...
        <div className="max-w-4xl w-full">
          ...
          <div className="bg-white shadow-lg p-8">
            ...
            <div className="flex items-center justify-between mb-8">
              ...
              {expiresAt && (
                <Timer expiresAt={expiresAt} onExpired={handleExpired} onAlmostExpired={handleAlmostExpired} />
              )}
            </div>
            ...
            <div className="space-y-8">
              ...
              <button
                ...
                disabled={loading || disablePayment}
