          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="flex flex-col justify-between h-full self-stretch w-full max-w-md ml-auto">
              <div className="space-y-8">
                <div>
                  <label className="block text-base font-light font-lexend mb-3 text-white/60">When</label>
                ...
                <div className="flex space-x-6">
                  <div className="flex-1">
                    <label className="block text-base font-light font-lexend mb-2 text-white/60">First Name</label>
                    <input
                      type="text"
                      value={firstName}
                  ...
                  <div className="flex-1">
                    <label className="block text-base font-light font-lexend mb-2 text-white/60">Last Name</label>
                    <input
                      type="text"
                      value={lastName}
                ...
                <div className="flex space-x-6">
                  <div className="flex-1">
                  <label className="block text-base font-light font-lexend mb-2 text-white/60">Phone Number</label>
                    <input
                      type="tel"
                      value={phone}
                  ...
                  <div className="flex-1">
                    <label className="block text-base font-light font-lexend mb-2 text-white/60">Special Requests</label>
                    <input
                      type="text"
