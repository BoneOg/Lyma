          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 md:gap-6 lg:gap-8 xl:gap-8 2xl:gap-8">
            ...
            <div className="flex flex-col justify-between h-full self-stretch w-full max-w-md lg:ml-auto md:mx-auto">
              <div className="space-y-6 sm:space-y-6 md:space-y-7 lg:space-y-8 xl:space-y-8 2xl:space-y-8">
                <div>
                  <label className="block text-sm sm:text-sm md:text-base lg:text-base xl:text-base 2xl:text-base font-light font-lexend mb-2 sm:mb-2 md:mb-3 lg:mb-3 xl:mb-3 2xl:mb-3 text-white/60">When</label>
                ...
                <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4 md:space-x-5 lg:space-x-6 xl:space-x-6 2xl:space-x-6">
                  <div className="flex-1">
                    <label className="block text-sm sm:text-sm md:text-base lg:text-base xl:text-base 2xl:text-base font-light font-lexend mb-2 text-white/60">First Name</label>
                    <input
                      type="text"
                      value={firstName}
                  ...
                  <div className="flex-1">
                    <label className="block text-sm sm:text-sm md:text-base lg:text-base xl:text-base 2xl:text-base font-light font-lexend mb-2 text-white/60">Last Name</label>
                    <input
                      type="text"
                      value={lastName}
                ...
                <div>
                  <label className="block text-sm sm:text-sm md:text-base lg:text-base xl:text-base 2xl:text-base font-light font-lexend mb-2 text-white/60">Email (Optional)</label>
                  <input
                    type="email"
                    value={email}
                ...
                <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4 md:space-x-5 lg:space-x-6 xl:space-x-6 2xl:space-x-6">
                  <div className="flex-1">
                  <label className="block text-sm sm:text-sm md:text-base lg:text-base xl:text-base 2xl:text-base font-light font-lexend mb-2 text-white/60">Phone Number</label>
                    <input
                      type="tel"
                      value={phone}
                  ...
                  <div className="flex-1">
                    <label className="block text-sm sm:text-sm md:text-base lg:text-base xl:text-base 2xl:text-base font-light font-lexend mb-2 text-white/60">Special Requests</label>
                    <input
                      type="text"
