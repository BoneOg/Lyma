  ...
  return (
    <section className="w-full bg-olive text-beige relative overflow-hidden">
      ...
      <div className="px-0 py-0 sm:py-16 md:py-20 lg:py-24 xl:py-28 relative z-10">
        ...
        <div className="hidden lg:block relative min-h-[600px] xl:min-h-[700px] 2xl:min-h-[800px]">
          {/* Left Image - Higher position */}
          <div className="absolute left-0 top-0 flex items-start">
            <img
              src="/assets/images/chef1.webp"
              alt="Chef Marc working in kitchen"
              className="max-w-[150px] lg:max-w-[300px] xl:max-w-[400px] 2xl:max-w-[450px] aspect-[9/16] object-cover -translate-y-8 xl:-translate-y-12 2xl:-translate-y-16 -translate-x-[25%] xl:-translate-x-[25%] 2xl:-translate-x-[25%]"
              loading="lazy"
            />
          </div>
          ...
          <div className="flex items-center justify-center min-h-[600px] xl:min-h-[700px] 2xl:min-h-[800px] px-8 xl:px-16 2xl:px-24">
            <div className="text-center font-lexend text-beige max-w-4xl xl:max-w-5xl 2xl:max-w-6xl">
              {/* Heading */}
              <div className="mb-8 xl:mb-10 2xl:mb-12">
                <p className="font-lexend tracking-[0.25em] mb-4 xl:mb-6 uppercase leading-tight text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-5xl font-light text-beige/60">
                  Meet Chef:
                </p>
                <p className="font-lexend tracking-[0.25em] uppercase text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-5xl font-light">
                  Marc Silvestre
                </p>
              </div>
              ...
              {/* Body Text */}
              <div className="mb-8 xl:mb-10 2xl:mb-12">
                <p className="font-lexend font-extralight text-sm sm:text-base md:text-lg lg:text-xl leading-7 sm:leading-8 md:leading-8 lg:leading-9 max-w-2xl xl:max-w-3xl 2xl:max-w-4xl mx-auto">
                  Born in L'Escala, Catalonia, Spain, Chef Marc Silvestre Carbó brings the flavors of Spanish cuisine and the finesse of European fine dining to the Philippines. Since moving to Siargao in 2017, Marc has become known as one of the leading international chefs in the Philippines, weaving together French finesse, Spanish tradition, Asian creativity, and the richness of Filipino ingredients to create dishes that tell the story of Siargao.
                </p>
              </div>
              ...
              <div>
                <a
                  href="/about"
                  className="inline-flex items-center gap-2 font-lexend font-semibold tracking-[0.25em] text-beige uppercase text-sm xl:text-base 2xl:text-lg"
                >
                  Chef Marc's Story 
                  <Arrow color="beige" size="md" />
                </a>
