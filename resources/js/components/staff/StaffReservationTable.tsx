            ...
            <table className="w-full text-left font-lexend table-fixed">
              ...
              <thead>
                <tr className="border-b border-gray-200 bg-white sticky top-0 z-0">
                  ...
                  <th className="py-3 px-1 font-semibold tracking-tighter truncate text-center">Status</th>
                  <th className="py-3 px-1 font-semibold tracking-tighter truncate text-center">Actions</th>
                </tr>
              </thead>
              <tbody>
                {sorted.map((reservation) => (
                  <ReservationTableRow
                    ...
                    onExpand={() => handleExpand(reservation.id)}
                    onComplete={() => handleComplete(reservation.id, reservation.guest_first_name, reservation.guest_last_name)}
                    onCancel={() => handleCancel(reservation.id, reservation.guest_first_name, reservation.guest_last_name)}
                  />
                ))}
              </tbody>
            </table>
