      ...
      <div className="relative mx-auto max-w-7xl px-6 py-10">
        ...
        <div className="text-center mb-8 mt-2">
          <div className="inline-flex items-center justify-center ">
            <div className="w-64 h-[2px] bg-gradient-to-r from-transparent to-[#3D401E]/30"></div>
            <div className="mx-8">
              <img 
            ...
            <div className="w-64 h-[2px] bg-gradient-to-l from-transparent to-[#3D401E]/30"></div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            <h3 className="text-2xl font-lexend font-light text-[#3D401E] mb-6 relative">
              Our Story
            ...
            <div className="space-y-6 pt-4">
              <div className="flex items-center space-x-3 text-[#3D401E]/80">
                <svg className="w-5 h-5 text-[#3D401E]/60" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z" clipRule="evenodd" />
                </svg>
                <p className="font-lexend font-light">{address}</p>
              </div>
              <div className="flex items-center space-x-3 text-[#3D401E]/80">
                <svg className="w-5 h-5 text-[#3D401E]/60" fill="currentColor" viewBox="0 0 20 20">
                ...
                <p className="font-lexend font-light">{email}</p>
              </div>
              <div className="flex items-center space-x-3 text-[#3D401E]/80">
                <svg className="w-5 h-5 text-[#3D401E]/60" fill="currentColor" viewBox="0 0 20 20">
                  <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z" />
                </svg>
                <p className="font-lexend font-light">{phone}</p>
              </div>
            </div>
          </div>
            ...
            <ul className="space-y-4">
              {NAV_LINKS.map(link => (
                <li key={link.label}>
                  <Link 
                    href={link.href} 
                    className="text-[#3D401E]/70 hover:text-[#3D401E] transition-all duration-300 font-lexend font-light tracking-wide uppercase text-sm hover:translate-x-1 inline-block"
                  >
                    {link.label}
                  </Link>
                </li>
          ...
          <div>
            ...
            <div className="mt-8 p-4 bg-[#3D401E]/5  border border-[#3D401E]/10">
              <p className="text-[#3D401E]/80 font-lexend font-light text-sm mb-3">
                Reservations recommended for dinner service
              </p>
              <Link 
                href="/reservation" 
                className="inline-block bg-[#3D401E] text-[#FAF7CA] px-4 py-2 rounded font-lexend font-regular text-sm hover:bg-[#3D401E]/90 transition-colors duration-300 uppercase tracking-wide"
              >
                Reserve Now
              </Link>
            </div>
        ...
        {/* Bottom Copyright */}
        <div className="border-t border-[#3D401E]/20 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center text-center md:text-left">
            <p className="text-[#3D401E]/60 font-lexend font-light text-sm">
              &copy; {new Date().getFullYear()} {restaurantName}. All rights reserved. Crafted with passion in Siargao.
            </p>
            <div className="flex items-center space-x-4 mt-4 md:mt-0 text-sm text-[#3D401E]/60">
